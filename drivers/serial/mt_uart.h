...
#ifndef ZEPHYR_DRIVERS_SERIAL_MT_UART_H_
#define ZEPHYR_DRIVERS_SERIAL_MT_UART_H_
...
#define UART_SET_BITS(REG, BS) sys_write32(sys_read32(REG) | (unsigned int)(BS), REG)
#define UART_CLR_BITS(REG, BC) sys_write32(sys_read32(REG) & ~((unsigned int)(BC)), REG)
...
#define UART_DLL_RE(uart)          ((uart) + 0x90)
#define UART_DLH_RE(uart)          ((uart) + 0x94)
...
#endif /* ZEPHYR_DRIVERS_SERIAL_MT_UART_H_ */
